...
export class Volunteering extends React.Component {
  ...
  render () {
    return (
      <div>
        <Header
          title="Volunteering And Hangouts"
          description="Where does Gavin hangout?"
        ...
        <div className="container">
          ...
          >
            <p>
              Help out where I can. Usually finding a group that wants to do a
              certain excersize at our events and help mentor them.
            </p>
            <p>
              <a href="https://community.vancouvertech.com/groups/nodeschool">
                forum
              </a>
              {' | '}
