  ...
  render () {
    return (
      <div>
        <Header
          title="Presentations"
          description="The presentations Gavin has given"
        ...
        <div className="container">
          ...
          >
            <div>
              Testing presentation for{' '}
              <a href="http://www.meetup.com/Code-Coffee-Vancouver/events/230135012/">
                Code Coffee Vancouver
              </a>. Goal was to show that testing doesn&apos;t have to be
              perfect, any you can really start anywhere.
            </div>
            <div>
              <a href="https://www.youtube.com/watch?v=iPGSJVASCkc">
                Youtube Recording
              </a>
            </div>
          </ItemBlock>
          ...
          >
            <div>
              Vagrant presentation for{' '}
              <a href="https://www.meetup.com/Code-Coffee-Vancouver/events/224950040/">
                Code Coffee Vancouver
              </a>. It was my first attempt at doing one for a large group.
            </div>
          </ItemBlock>
          <ItemBlock
          ...
          >
            <div>
              Tried to show off some of the things that react does better than
              angular to the team.
            </div>
          </ItemBlock>
          ...
          >
            <div>
              Presentation on sharing my devops interest to align our team on
          ...
          >
            <div>
              I did a quick tutorial session for my last workplace. Covers a lot
              of the vim basics. <b>Warning:</b> Does have a couple minor swear
              words like shit
            </div>
          </ItemBlock>
          ...
          <div className="well">
            ...
            <ul>
              <li>
                ...
                &nbsp; - Presentations designed to give at work. May not make a
                lot of sense out of context.
              </li>
              <li>
