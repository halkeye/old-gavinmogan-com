  ...
  render () {
    return (
      <div>
        <Header
          title="Projects"
          description="Some of the projects Gavin has worked on"
          pathname={this.props.router.pathname}
        />
        <div className="container">
          <h1>Projects</h1>
          <p>
            There&apos;s a lot more projects on my{' '}
            <a href="https://github.com/halkeye">
          ...
          >
            ...
            <div>
              <a href="https://github.com/halkeye/react-book-reader">Github</a>
            </div>
          </ItemBlock>
          ...
          >
            ...
            <div>
              <a href="https://github.com/halkeye/zabox">Github</a>
            </div>
          </ItemBlock>
          ...
          >
            <div>
              I wanted an excuse to play with some html5 audio and canvas, so
              created a fun little game for{' '}
              <a href="http://www.criticalhitshow.com/">Critical Hit Show.</a>
            </div>
          </ItemBlock>
          ...
          >
            <div>
              Small little web app I created for{' '}
              <a href="https://www.mozilla.org/en-US/firefox/os/2.0/">
                Firefox OS
              </a>{' '}
              to learn how it works
            </div>
            <div>
              <a href="https://github.com/halkeye/infinicatr">Github</a>
            </div>
            <div>
              <a href="https://marketplace.firefox.com/app/infinicatr/">
                Firefox (OS) App
              </a>
            </div>
            <div>
              <a href="https://chrome.google.com/webstore/detail/infinicatr/dikkcbebmfnedmojoipnoonmionakoka">
                Chrome App
              </a>
            </div>
          </ItemBlock>
          ...
          >
            <p>
              A project I worked on with{' '}
              <a href="https://twitter.com/Uch1koma">Stephen Tiu</a> for some of
              the various conventions we volunteered at. It was an attempt to be
              a self manage ticketing system that could easily be resued year to
              year.
            </p>
            <div>
              <a href="https://github.com/halkeye/ecmproject">Github</a>
            </div>
          </ItemBlock>
          ...
          >
            <div>
              ...
              <p>
                This one is done by both Mark Gottselig and myself (Gavin
                Mogan), as well as a few other people submitting various pieces
                along the way.
              </p>
            </div>
          </ItemBlock>
          ...
          >
            <div>
              <p>
                My first mud project. Where I learned all the fun things to do
                with network programming and linux and such.
              </p>

              <p>
                Looking back it kinda makes me cringe, but its a big part of me.
              </p>
            </div>
          </ItemBlock>
          ...
          >
            <div>
              <p>
                Some tool for a long lost open source service that livejournal
                used to run
              </p>
          ...
          >
            <div>
              <p>
                Long time ago in a galaxy far far away, I was using Moveable
                Type as a blogging engine.
              </p>
              <p>
                This is a tool I wrote that cross posted things to livejournal.
                It was pretty popular and I got to know most of the major users.
              </p>
            </div>
          </ItemBlock>
        </div>
